...
void delayWatch(void) {
  printf("max delay(%lums) delay(%lums)  last(%lums)  initial(%lums)  over?(%d)\n",
          msTimer.delayMS, msTimer.lastMS, msTimer.initialMS, msTimer.delayOver);
}

void usDelayWatch(void) {
  printf("max delay(%luus) delay(%luus)  last(%luus)  initial(%luus)  over?(%d)\n", \
...
bool msTimeoutOnBoolean(bool * waitBool, bool waitOnValue, unsigned long delayMS, unsigned long sampleIntervalMS) {
...
bool usTimeoutOnBoolean(bool * waitBool, bool waitOnValue, unsigned long delayUS, unsigned long sampleIntervalUS) {
